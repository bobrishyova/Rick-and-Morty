...
const CharacterItem = ({ item = {} }) => {
  ...
  return (
    <div className="divWithCharacterInformation">
      <Link className="divCharacterName" style={linksCharacterItem} to={`/character/${item.id}`}>
        <p className="itemCharacter">{item.name}</p>
      </Link>
      <Link className="divCharacterItem" style={linksCharacterItem} to={`/character/${item.id}`}>
